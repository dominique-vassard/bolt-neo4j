defmodule BoltNeo4j.DecoderV2Test do
  ...
  alias BoltNeo4j.Types.{Duration, TimeWithTZ, Point}
  ...
  describe "Decode spatial types" do
    test "cartesian point 2d" do
      res = Point.create(:cartesian, 40, 45)
    ...
    test "cartesian point 3d" do
      res = Point.create(:cartesian, 40, 45, 150)
    ...
    test "geographic point 3d" do
      res = Point.create(:wgs_84, 40, 45, 150)
